...
function initSliders() {
  if (window.innerWidth <= 650) {
    if (document.querySelector(".benefits__slider")) {
      benefitsSlider = new Swiper(".benefits__slider", {
        modules: [Navigation],
        observer: true,
        observeParents: true,
        slidesPerView: 1,
        ...
        speed: 800,
        navigation: {
          prevEl: ".benefit__navigation .swiper-button-prev",
          nextEl: ".benefit__navigation .swiper-button-next"
        }
      });
    }
  } else {
  ...
  if (window.innerWidth <= 650) {
    if (document.querySelector(".collab__slider")) {
      collabSlider = new Swiper(".collab__slider", {
        ...
        speed: 800,
        navigation: {
          prevEl: ".collab__navigation .swiper-button-prev",
          nextEl: ".collab__navigation .swiper-button-next"
        }
      });
    }
  } else {
    if (collabSlider) {
      collabSlider.destroy(true, true);
      collabSlider = null;
    }
  }
  if (document.querySelector(".equipment__slider")) {
    new Swiper(".equipment__slider", {
      ...
      speed: 800,
      navigation: {
        prevEl: ".equipment__navigation .swiper-button-prev",
        nextEl: ".equipment__navigation .swiper-button-next"
      },
      breakpoints: {
        320: {
          slidesPerView: 1,
